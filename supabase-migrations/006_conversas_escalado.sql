-- Marca se o turno da Recepta (role='ia') disparou escalonamento humano ([HANDOFF]).
-- O marcador [HANDOFF] hoje e removido do texto antes de gravar em conversas.mensagem
-- (node "Processar Resposta Recepta" do workflow n8n) e a flag precisa_escalar so existe em
