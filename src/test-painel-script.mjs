...
try {
  const { paginaPainel } = await import(
  ...
  // 5o argumento veio com a feature de categorias (de29097): sem ele o
  // painel-view estoura em jsonParaScript(undefined).
  const categoriaDados = {
    categoria: "estetica",
    categoriaMeta: { nome: "Estetica" },
    tabsVisiveis: ["precos", "faq", "procedimentos"],
    camposExtras: [],
    regrasCategoria: "",
    faqCategoria: [],
  };
